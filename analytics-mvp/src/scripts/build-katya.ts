...
function renderOrdersAnalytics(cur){
  ...
  var SUMK=['units','dlv','fly','flyAcc','tb','acc','com','del','acq','sto','oth','prt','adv','amt','amtS','cc','ship','dinc'];
