 ...
 * NEXT_PUBLIC_NO_PHOTOS=1 отключает внешние снимки целиком: на публичной сборке
 * они грузятся со стороннего хоста, и вместо неоткрывшегося снимка честнее
 * показать подложку.
 */
const NO_PHOTOS = process.env.NEXT_PUBLIC_NO_PHOTOS === "1";
...
export function Photo({
  ...
  const src = NO_PHOTOS ? null : unsplash(id, 1000);
  return (
