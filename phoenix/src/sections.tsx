...
export function Glavnoe() {
  const items = [
    ...
    ["Бюджет за месяц не сократился, он перетёк.",
      "Товарную галерею остановили 16 августа, и это правильно, но экономии не вышло: за 14 дней после остановки потрачено почти столько же, сколько за 16 дней до неё. Деньги перетекли на Поиск."],
  ];
  return (
