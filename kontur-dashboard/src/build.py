...
Вид целиком из своей копии пакета kontur-dashboard/kontur-ds/ (Контур DS 1.5): токены и
...
ROOT = HERE.parent
DS = ROOT / 'kontur-ds'   # своя копия пакета проекта (с 25.09.2026), общий дом Контура в /kontur-ds
