...
экспертного. [ДАННЫЕ: GEO-разведка рунета 06.2026, c=0.6]
...
Алисе). [ДАННЫЕ: GEO-разведка рунета 06.2026, c=0.6]
...
- Сравнительная таблица (материал, толщина стекла, профиль, вилка цены, гарантия) -
  AI берёт данные из таблиц в 3-4 раза чаще, чем из сплошного текста.
...
конфликт с Comprehension Gate и citation-worthy уникальностью.
...
- **Prompt Win Rate (PWR)** = упоминания бренда / всего промптов × 100. <10% невидим,
  10-30% базовая видимость, >30% сильная.
...
- **Stability** (держимся ли при повторах), **Coverage** (доля промптов, где мы есть),
  **Answer Share** (доля ответа на нас). Источник формул: `geo-intel-runet-2026.html`.
