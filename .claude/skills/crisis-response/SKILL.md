...
## Plan B Template (use during Phase 2)
...
## Sub-scenarios beyond default 3 (Cash/Channel/Refunds)

### T2 - Потеря РОПа

- **Немедленно:** Иван берёт продажи на 2 недели, объявление о найме
- **Среднесрок:** AI-скрипты ВИКТОРА #13 снижают зависимость. Кросс-обучение второго менеджера
- **Day 30:** новый РОП onboarded + AI fallback подтверждён

### T4 - Срыв производства >5 заказов

- **Day 0:** stop-lock на новые заказы той же категории
- **Day 1:** root cause analysis (оборудование / материалы / люди)
- **Day 3:** компенсационная коммуникация с пострадавшими клиентами (МАРКО + ЭММА)
- **Day 7:** process fix + проверка остальных WIP
- **Day 14:** postmortem

### T6 - Выручка <80% × 2 недели

- **Day 0:** re-forecast Q + freeze CAPEX
- **Day 3:** аудит pipeline в Bitrix24 (где встал) - БОРИС
- **Day 7:** реактивация спящих лидов (ВИКТОР campaign)
- **Day 14:** structural decision (cuts / new channel / pivot)
