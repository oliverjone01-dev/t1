...
describe("свод: колонка «Наша доставка»", () => {
  ...
  it("строки-моста «без С\\С» нет, а в колонке С\\С стоит прочерк", () => {
    ...
    // Артикулы без С\С в таблице есть, и они помечены счётчиком у категории. Июль для этого
    // больше не годится: 21.09.2026 Катя закрыла СС по 13 артикулам, и в июле пробелов не
    // осталось. Единственный оставшийся - GGT-15-2, он продавался в январе.
    setRange("2026-01-01", "2026-01-31");
