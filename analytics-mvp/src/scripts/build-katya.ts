...
function paint(a,src){
  ...
  document.getElementById('top').innerHTML=(a.top_spend||[]).map(function(c,ci){
    ...
    if(has){
      ...
      var inner='<div style="overflow-x:auto"><table class="kt-table" style="margin:0;min-width:560px"><thead><tr><th>SKU в продвижении</th><th>Инструмент</th><th>Место</th><th class="r">Расход</th><th class="r">Выручка</th><th class="r">Заказы</th><th class="r">ДРР</th></tr></thead><tbody>'+rowsH+'</tbody></table></div>';
