...
**OTE по уровням** [ГИПОТЕЗА: реальные цифры GENGROUP требует синхронизации с Romaн + HR; здесь rough placeholder]:
...
- Не менять comp-структуру чаще раза в год без объявления за 60 дней (Iван должен подписать)
