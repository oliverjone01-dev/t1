...
<div class="wrap">
  ...
  <section id="s2" class="reveal">
    ...
    <div class="arch3">
      ...
      <div class="pair">
        <div class="bx hero"><div class="r">ГЕРОЙ · ЛИЦО ЗАВТРА</div><h4>VALONTI</h4><p>Custom из премиальных материалов. Заходим к дизайнерам через него. Mid-premium, растём к premium.</p></div>
  ...
  <section id="s9" class="reveal">
    ...
    <div class="frame">
      ...
      <div class="f"><span class="m mk keep">метка</span><div><b>Поле «Канал лида» = «ТОН»</b> ''' + D + ''' на карточке дизайнера, переносится в сделку и смарт-процесс «Индивидуальный проект». Без метки канал слепой. Цель-ориентир: 8-12 артикулов в работе к концу 2026 ''' + PH + '''.</div></div>
    </div>
  ...
  <section id="s10" class="reveal">
    ...
    <div class="frame" style="margin-top:16px">
      <div class="f"><span class="m mk keep">✓</span><div><b>Можно говорить (подтверждено glossary):</b> надбавка за нестандарт +5-15%, авторская модель +15-30%, bespoke 20-90 дней, метка «Канал лида = ТОН» в Bitrix24.</div></div>
      ...
      <div class="f"><span class="m mk invest">▸</span><div><b>Решить до операционного запуска custom:</b> MOQ, лимит просчётов и правок, ставка часа команды для учёта пресейл-затрат. Без них поток custom - под стоп.</div></div>
    </div>
  </section>
