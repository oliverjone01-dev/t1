...
function renderUecon(a){
  ...
  (a.top_spend||[]).forEach(function(c){
    ...
    rows.push({camp:c.id,art:art,status:c.status,sp:sp,om:om,drr:drr,ord:ord,com:com,cogs:cogsPct,price:price,comRub:comRub,cogsRub:cogsRub,be:be,head:head,v:v});
  });
