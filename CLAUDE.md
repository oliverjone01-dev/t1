...
- ФЕНИКС классифицирует артефакт (стратегия / контент наружу / гейт-инструмент / дашборд / агент-skill), гоняет red-team пробы класса (`phoenix-eval/references/red-team-probes.md`); гейт, дашборд или агент без проб - risk_awareness ≤ 5.0 и verdict не выше `return`.
