...
технических гейтов. Поэтому оценка ФЕНИКСА, полученная в Cowork без Bash, не поднимается выше 7.9 для гейтов,
дашбордов и агентов (phoenix-eval, поправки v3), а критические артефакты (CLAUDE.md §4) проходят повторный
