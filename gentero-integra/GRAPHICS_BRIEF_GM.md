...
Четыре кадра первой партии. Ещё два кадра под разделы «Лидген и СУЗ» и
«Ритуальный канал» описаны отдельно в `GRAPHICS_BRIEF_NPB.md`: там промты
под Nano Banana Pro, а здесь под GPT Image, формулировки разные.

Слоты в вёрстке уже стоят и до появления файлов показывают
