...
Как поставить в новый проект и обновлять: `INSTALL.md`. Проверка в GitHub: `ci/kontur-ds.yml`.
...
1.5.2: выключатель ложной тревоги для законного приёма (`--ks-allow: "КОД: причина"`, причина обязательна,
выключенное видно заметкой), цвет мимо токенов в разметке из скрипта и атрибутами SVG и HTML, живой слой
открывает страницы по пути с `#`. Замер: 175 из 175, ложных тревог 0 из 48, живьём 19 из 19. DESIGN_SYSTEM.md, раздел 20.
