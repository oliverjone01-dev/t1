...
function anCells(x){
  ...
  return R(x.rev)+I(x.units)+R(x.acc)+R(x.com)+R(x.del)+R(x.acq)+R(x.sto)+R(x.oth)+R(fees)+R(x.amt)+R(x.cc)+P(gp)+R(adm)+R(tax)+PC(rent);
}
