...
- Динамика к прошлой неделе обязательна везде: у каждой цифры в тексте пиши «было→стало» (факты уже дают пары). Без пары прошлой недели цифру не оценивай как рост или падение.
- Прошлый вывод может содержать ошибки: если он расходится с фактами прошлой недели, верь фактам.
- Уволенных (Ольга Маслова) не упоминать.
