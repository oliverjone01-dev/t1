...
| Что | Факт | Следствие |
|---|---|---|
| Кабинеты | все 6 кампаний ключа `YM_DASHBOARD_1` в 74986385 «GEN GROUP» (мебель); у 1023124 «GENGLASS» (зеркала) кампаний нет, `offer-mappings` и отчёты по нему - 403 | зеркала на дашборд не попадают, пока аккаунт ключа не принят в кабинет зеркал (действие Ивана) |
