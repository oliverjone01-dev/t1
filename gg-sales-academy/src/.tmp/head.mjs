...
// ─────────────────────────────────────────────────────────── правовая
// ─────────────────────────────────────────────── кабинеты и сводка
// Раздел существует, чтобы личные страницы жили внутри сайта, а не приходили
// файлами. Имён и адресов кабинетов здесь нет намеренно: адрес обезличен ровно
// для того, чтобы список «кто под каким адресом» не лежал в открытом контуре.
// Этот список живёт внутри зашифрованной сводки.
sec("kabinety", "Кабинеты и сводка", "Кабинеты и сводка",
  ...
  <h3>Личный кабинет менеджера</h3>
  <p>У каждого свой адрес и общий пароль кабинетов. Открыв свою ссылку, человек получает
  эту же академию целиком, только первым разделом в меню стоит его собственный разбор.</p>
