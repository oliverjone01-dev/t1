...
const deals = rop.deals.map((d: any) => ({
  ...
  created: d.created, activity: d.activity, taskDue: d.taskDue, taskSubj: d.taskSubj, lastTouch: d.lastTouch || null, closed: d.closed, source: d.source, client: d.client,
