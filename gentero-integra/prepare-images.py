...
SPEC = {
    ...
    # шапки карточек в разделах «почему сейчас» и «пакет», слот .m-fimg, 16:9
    "fact-01":            (1200,  675, 78),
    "fact-02":            (1200,  675, 78),
    "fact-03":            (1200,  675, 78),
    "fact-04":            (1200,  675, 78),
    ...
    "part-04":            (1200,  675, 78),
    "part-05":            (1200,  675, 78),
    # вкладка DG & GM, презентационная версия
    "gm-hero":            (2400, 1350, 82),
    "gm-portrait":        (1600,  900, 80),
    "gm-complex":         (1600,  900, 80),
    "gm-metal-fence":     (1600,  900, 80),
    # разделы «лидген и СУЗ» и «ритуальный канал», промты в GRAPHICS_BRIEF_NPB.md
    "gm-suz":             (1600,  900, 80),
    "gm-ritual":          (1600,  900, 80),
    "gm-expo":            (1600,  900, 80),
}
