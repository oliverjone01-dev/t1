...
**Почему 5 критериев, не 6:** шестым кандидатом был «Coherence/Связность» из v8 (кросс-документная согласованность). Частично покрыт чекпоинтом 3 (не противоречит knowledge/semantic/). Полное возвращение = 30 чекпоинтов и рост времени аудита на ~20% - отклонено до появления доказательств, что Accuracy-3 систематически пропускает несогласованность.
