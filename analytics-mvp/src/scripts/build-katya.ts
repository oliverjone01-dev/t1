...
// таблицей ниже: за июль план показывал выручку 15 287 504 ₽ и чистую -294 510 ₽ против
// 9 722 328 ₽ и 140 942 ₽ в своде. Статьи тоже свои: «начислено» у Маркета нет как показателя,
