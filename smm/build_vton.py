...
<div class="wrap">
  ...
  <section id="s7" class="reveal">
    ...
    <div class="frame">
      ...
      <div class="f"><span class="m mk gold">4</span><div><b>Удержание дизайнеров</b> - доля давших 2-ю и 3-ю спеку. <b>Самая важная метрика канала</b>: она отличает высокую маржу от дорогой розницы. <b>Порог-ориентир: при удержании 2-й спеки ≥40% канал бьёт прямой платный B2D по CAC</b> <span class="tag-inline hyp">ГИПОТЕЗА - проверить на baseline</span>.</div></div>
  ...
  <section id="s8" class="reveal">
    ...
    <div class="frame">
      <div class="f"><span class="m mk gold">▸</span><div>Время команды (0.2-0.4 FTE × 90 дней × ставка ~1500 ₽/ч <span class="tag-inline hyp">ГИПОТЕЗА</span>) - <b>~55-90 000 ₽</b>, в смете берём центр ~70 000 ₽ · самая недооценённая статья</div></div>
  ...
  <section id="s9" class="reveal">
    ...
    <div class="traps">
      ...
      <div class="trap"><div class="tnum">SINGLE POINT OF FAILURE</div><h4>Весь доступ к дизайнерам - через кураторов</h4><p>База и доверие идут через Ксенофонтовых. Испортятся отношения - канал схлопывается.</p><div class="fix"><b>Закрытие:</b> копим собственный актив - своя база дизайнеров с тегом «ТОН», прямые контакты с экспозиции, не только через кураторов. <b>Сцепка с юр-риском:</b> своя база растёт только на согласиях ПД, собранных у нас на стенде (152-ФЗ) - это и есть путь к независимости от кураторов. Резидентство - партнёрство, не зависимость.</div></div>
    </div>
  </section>
