...
<div class="wrap">
  ...
  <section id="s8" class="reveal">
    ...
    <div class="callout"><b>Anti-median (пройдено):</b> заход от среза материала, а не от интерьер-рендера; один герой, бренды не свалены в кучу; тишина и медленный темп вместо трека и нарезки; конкретика «режем под размер» вместо «непревзойдённое качество». GENGLASS в ролике не показываем вовсе. Палитра: ЧЁРНАЯ-фон, камень/бронза/сталь, золото только в материале и блике. В титрах проверить: нет слова «роскошь», нет em dash.</div>
  </section>
