...
function anCells(x){
  ...
  return I(x.units)+R(x.acc)+R(x.com)+mid+R(fees)+R(x.amt)+R(x.cc)+shipCell+incCell+P(gp)+R(adm)+R(tax)+P(net)+PC(rent)+cityCell;
}
