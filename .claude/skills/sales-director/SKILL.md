...
4. **Refund / replacement / производственный брак.** Алёрт на сделках в `C49:LOSE` после `C49:WON` (история стадий). Виктория Преснtakeова сделка 2 (молчание про брак 3 недели) - анкер этой проблемы.
...
- Mr.Doors / Hoff - дилерская модель, маржа дилера диапазон 15-30%
