...
function renderTop(){var a=lastA;if(!a)return;
  ...
  var html=list.map(function(c,ci){
    ...
    var st='<td class="r">'+(c.vw==null?'—':fmtRu(c.vw))+'</td><td class="r">'+(c.cl==null?'—':fmtRu(c.cl))+'</td><td class="r">'+(c.ca?fmtRu(c.ca):'—')+'</td><td class="r">'+(c.ctr==null?'—':(c.ctr+'%'))+'</td><td class="r">'+(c.cpc==null?'—':fmtRu(c.cpc))+'</td>';
